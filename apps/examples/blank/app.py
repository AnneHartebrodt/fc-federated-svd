...
@app_state('initial', next_state = 'config')  # The first argument is the name of the state ('initial'), the second specifies which roles are allowed to have this state (here BOTH)
class InitialState(AppState):

    def register(self):
        self.register_transition('config')  # We declare that 'terminal' is accessible from the 'initial' state
