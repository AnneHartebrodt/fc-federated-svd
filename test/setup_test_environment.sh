...
python $pydir/generate_config_files.py -d $outputfolder -o $dirname -b 1 -i 1000 -q 0 -s 0 -p 2 -n 0 --rownames 0 --header 0 --count 0 \
  --center $center --log_transform log  --variance $variance #--phv $phv -
#
#python $pydir/generate_config_files.py -d $outputfolder -o $dirname -b 1 -i 1000 -q 0 -s 0 -p 2 -n 0 --rownames 0 --header 0 --count 1 \
#  --center $center --variance $variance #--log_transform log #--phv $phv -
#
#python $pydir/generate_config_files.py -d $outputfolder -o $dirname -b 1 -i 1000 -q 0 -s 0 -p 2 -n 0 --rownames 0 --header 0 --count 2 \
#  --center $center #--variance $variance #--log_transform log #--phv $phv -
#
#python $pydir/generate_config_files.py -d $outputfolder -o $dirname -b 1 -i 1000 -q 0 -s 0 -p 2 -n 0 --rownames 0 --header 0 --count 3 \
#  #--center $center #--variance $variance #--log_transform log #--phv $phv -
#
#python $pydir/generate_config_files.py -d $outputfolder -o $dirname -b 1 -i 1000 -q 0 -s 0 -p 2 -n 0 --rownames 0 --header 0 --count 4 \
#   --variance $variance #--log_transform log #--phv $phv #--center $center
#
#python $pydir/generate_config_files.py -d $outputfolder -o $dirname -b 1 -i 1000 -q 0 -s 0 -p 2 -n 0 --rownames 0 --header 0 --count 5 \
#    --log_transform log #--phv $phv #--center $center --variance $variance

#compute canonical solution
#python $pydir/compute_canonical_solution.py -d $outputfolder -f $datafile -k $k -s $seed  --header 0 \
#  --transpose True --rownames 0 --center $center --variance $variance --log_transform log #--phv $phv
#
